...
void JOY_IsCenter(void) {
    if ((50 < joystick[0]) && (joystick[0] < 200)) {
        if ((50 < joystick[1]) && (joystick[1] < 200)) {
            enable = 1;
        }
    }
}
...
char JOY_IsLeft(void) {
    if ((joystick[1] > 50) && (joystick[1] < 200)) {
        if ((joystick[0] < 50) && enable) {
            enable = 0;
            return 1;
        }
    }
